...
//---------------------------------------WEB-----------------------------------------------
//-----------------------------------------------------------------------------------------
$changelog_dir=('./index_files/pages/index/changelog.txt');
$changelog_array = file($changelog_dir);
$changelog_arraysize=(sizeof($changelog_array))-1; //Note array size is offset by 1
...
$w_con_t='
<div id="content">
    <div class="window_center_large" id="changelog_window"><div class="text">
';
...
print $w_con_t;
for ($changelog_loop_start=0; $changelog_loop_start <= $changelog_arraysize; $changelog_loop_start++){
    //print (($changelog_array[$changelog_loop_start])."<br>");
    print markdown(filter($changelog_array[$changelog_loop_start])).'<br>';
}
print $w_con_b;
