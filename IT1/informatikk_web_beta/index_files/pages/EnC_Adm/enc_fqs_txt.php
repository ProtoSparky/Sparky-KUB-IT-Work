...
if (empty($_SESSION["is_logged_in"])){
    ...
    if ($_SESSION["is_logged_in"]=="1"){
        //prints when user is logged in
                ...
                //---------------------------------------WEB-----------------------------------------------
                //-----------------------------------------------------------------------------------------
                $changelog_dir = '../index/changelog.txt';
                $changelog_array = file($changelog_dir);            
                $changelog_form_top = '
                    <form method="POST" action="">
                        <textarea class="textarea" id="changelog_textarea" name="changelog_textarea" rows="40" cols="132">
                ';
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    if (empty($_POST['changelog_textarea'])) {} 
                        ...
                        $changelog_form_input = trim($_POST['changelog_textarea']);
